"""document.origin_url: URL de origen de fuentes aprobadas (doc_type=reference)
...
Learn…) se cargan como documentos con doc_type='reference'. Esta columna guarda la
URL de origen cuando se dan de alta por web. Nullable: los documentos existentes
quedan con NULL.
"""
